...
class TranslationKeys(str, Enum):
    ...
    # Presets menu
    TRANSLATION_TEXT_PRESETSMENU_PRESETS = "TRANSLATION_TEXT_PRESETSMENU_PRESETS"
    TRANSLATION_TEXT_PRESETSMENU_SAVE_PRESET = "TRANSLATION_TEXT_PRESETSMENU_SAVE_PRESET"
    TRANSLATION_TEXT_PRESETSMENU_LOAD_PRESET = "TRANSLATION_TEXT_PRESETSMENU_LOAD_PRESET"
    TRANSLATION_TEXT_PRESETSMENU_MANAGE_PRESETS = "TRANSLATION_TEXT_PRESETSMENU_MANAGE_PRESETS"

    # Preset Manager Dialog
    TRANSLATION_TEXT_PRESET_DIALOG_TITLE = "TRANSLATION_TEXT_PRESET_DIALOG_TITLE"
    TRANSLATION_TEXT_PRESET_DIALOG_APPLY = "TRANSLATION_TEXT_PRESET_DIALOG_APPLY"
    TRANSLATION_TEXT_PRESET_DIALOG_RENAME = "TRANSLATION_TEXT_PRESET_DIALOG_RENAME"
    TRANSLATION_TEXT_PRESET_DIALOG_DELETE = "TRANSLATION_TEXT_PRESET_DIALOG_DELETE"
    TRANSLATION_TEXT_PRESET_DIALOG_CLOSE = "TRANSLATION_TEXT_PRESET_DIALOG_CLOSE"
    TRANSLATION_TEXT_PRESET_DIALOG_PREVIEW = "TRANSLATION_TEXT_PRESET_DIALOG_PREVIEW"

    # Save preset dialog prompts
    TRANSLATION_TEXT_PRESET_SAVE_TITLE = "TRANSLATION_TEXT_PRESET_SAVE_TITLE"
    TRANSLATION_TEXT_PRESET_SAVE_PROMPT = "TRANSLATION_TEXT_PRESET_SAVE_PROMPT"
    TRANSLATION_TEXT_PRESET_SAVE_OVERWRITE_TITLE = "TRANSLATION_TEXT_PRESET_SAVE_OVERWRITE_TITLE"
    TRANSLATION_TEXT_PRESET_SAVE_OVERWRITE_MSG = "TRANSLATION_TEXT_PRESET_SAVE_OVERWRITE_MSG"
    TRANSLATION_TEXT_PRESET_SAVE_SUCCESS = "TRANSLATION_TEXT_PRESET_SAVE_SUCCESS"

    # Rename preset dialog prompts
    ...
    TRANSLATION_TEXT_PRESET_ERROR_TITLE = "TRANSLATION_TEXT_PRESET_ERROR_TITLE"
    TRANSLATION_TEXT_PRESET_ERROR_INVALID = "TRANSLATION_TEXT_PRESET_ERROR_INVALID"
    TRANSLATION_TEXT_PRESET_DELETE_CONFIRM_TITLE = "TRANSLATION_TEXT_PRESET_DELETE_CONFIRM_TITLE"
    TRANSLATION_TEXT_PRESET_DELETE_CONFIRM_MSG = "TRANSLATION_TEXT_PRESET_DELETE_CONFIRM_MSG"
    TRANSLATION_TEXT_PRESET_NO_SELECTION = "TRANSLATION_TEXT_PRESET_NO_SELECTION"
    TRANSLATION_TEXT_PRESET_WARNINGS_TITLE = "TRANSLATION_TEXT_PRESET_WARNINGS_TITLE"
    TRANSLATION_TEXT_PRESET_ERROR_NAME_EXISTS = "TRANSLATION_TEXT_PRESET_ERROR_NAME_EXISTS"
    TRANSLATION_TEXT_PRESET_ERROR_INVALID_NAME = "TRANSLATION_TEXT_PRESET_ERROR_INVALID_NAME"
...
TRANSLATION_MEMORY: List[TranslationEntry] = [
    ...
    # Presets
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_PRESETSMENU_PRESETS, default="Presets"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_PRESETSMENU_SAVE_PRESET, default="Save Preset..."),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_PRESETSMENU_LOAD_PRESET, default="Load Preset..."),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_PRESETSMENU_MANAGE_PRESETS, default="Manage Presets..."),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_PRESET_DIALOG_TITLE, default="Preset Manager"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_PRESET_DIALOG_APPLY, default="Apply"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_PRESET_DIALOG_RENAME, default="Rename"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_PRESET_DIALOG_DELETE, default="Delete"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_PRESET_DIALOG_CLOSE, default="Close"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_PRESET_DIALOG_PREVIEW, default="Preview"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_PRESET_SAVE_TITLE, default="Save Preset"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_PRESET_SAVE_PROMPT, default="Enter preset name:"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_PRESET_SAVE_OVERWRITE_TITLE, default="Overwrite Preset"),
    TranslationEntry(
        id=TranslationKeys.TRANSLATION_TEXT_PRESET_SAVE_OVERWRITE_MSG,
        default="Preset already exists. Overwrite?",
    ),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_PRESET_SAVE_SUCCESS, default="Preset saved successfully!"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_PRESET_RENAME_TITLE, default="Rename Preset"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_PRESET_RENAME_PROMPT, default="Enter new name:"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_PRESET_ERROR_TITLE, default="Preset Error"),
    TranslationEntry(
        id=TranslationKeys.TRANSLATION_TEXT_PRESET_ERROR_INVALID,
        default="Invalid preset! The following fields have errors:",
    ),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_PRESET_DELETE_CONFIRM_TITLE, default="Delete Preset"),
    TranslationEntry(
        id=TranslationKeys.TRANSLATION_TEXT_PRESET_DELETE_CONFIRM_MSG,
        default="Delete preset? This cannot be undone.",
    ),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_PRESET_NO_SELECTION, default="Please select a preset first."),
    TranslationEntry(
        id=TranslationKeys.TRANSLATION_TEXT_PRESET_WARNINGS_TITLE, default="Preset Warnings"
    ),
    TranslationEntry(
        id=TranslationKeys.TRANSLATION_TEXT_PRESET_ERROR_NAME_EXISTS,
        default="A preset with this name already exists.",
    ),
    TranslationEntry(
        id=TranslationKeys.TRANSLATION_TEXT_PRESET_ERROR_INVALID_NAME,
        default="Invalid preset name. Please use a different name.",
    ),
]
