...
class TranslationKeys(str, Enum):
    ...
    TRANSLATION_TEXT_TOOLSMENU_TOOLS = "TRANSLATION_TEXT_TOOLSMENU_TOOLS"
    TRANSLATION_TEXT_TOOLSMENU_OFFSET_SCANNER = "TRANSLATION_TEXT_TOOLSMENU_OFFSET_SCANNER"
    TRANSLATION_TEXT_SCANNER_WINDOW_TITLE = "TRANSLATION_TEXT_SCANNER_WINDOW_TITLE"
    TRANSLATION_TEXT_SCANNER_PARAMS_FRAME = "TRANSLATION_TEXT_SCANNER_PARAMS_FRAME"
    TRANSLATION_TEXT_SCANNER_START = "TRANSLATION_TEXT_SCANNER_START"
    TRANSLATION_TEXT_SCANNER_END = "TRANSLATION_TEXT_SCANNER_END"
    TRANSLATION_TEXT_SCANNER_STEP = "TRANSLATION_TEXT_SCANNER_STEP"
    TRANSLATION_TEXT_SCANNER_ALIGNMENT = "TRANSLATION_TEXT_SCANNER_ALIGNMENT"
    TRANSLATION_TEXT_SCANNER_MAX_RESULTS = "TRANSLATION_TEXT_SCANNER_MAX_RESULTS"
    TRANSLATION_TEXT_SCANNER_SCAN = "TRANSLATION_TEXT_SCANNER_SCAN"
    TRANSLATION_TEXT_SCANNER_CANCEL = "TRANSLATION_TEXT_SCANNER_CANCEL"
    TRANSLATION_TEXT_SCANNER_CLOSE = "TRANSLATION_TEXT_SCANNER_CLOSE"
    TRANSLATION_TEXT_SCANNER_RESULTS_FRAME = "TRANSLATION_TEXT_SCANNER_RESULTS_FRAME"
    TRANSLATION_TEXT_SCANNER_STATUS_READY = "TRANSLATION_TEXT_SCANNER_STATUS_READY"
    TRANSLATION_TEXT_SCANNER_STATUS_SCANNING = "TRANSLATION_TEXT_SCANNER_STATUS_SCANNING"
    TRANSLATION_TEXT_SCANNER_STATUS_DONE = "TRANSLATION_TEXT_SCANNER_STATUS_DONE"
    TRANSLATION_TEXT_SCANNER_STATUS_CANCELLED = "TRANSLATION_TEXT_SCANNER_STATUS_CANCELLED"
    TRANSLATION_TEXT_SCANNER_STATUS_LIMIT = "TRANSLATION_TEXT_SCANNER_STATUS_LIMIT"
    TRANSLATION_TEXT_SCANNER_SUMMARY_SCANNED = "TRANSLATION_TEXT_SCANNER_SUMMARY_SCANNED"
    TRANSLATION_TEXT_SCANNER_SUMMARY_FOUND = "TRANSLATION_TEXT_SCANNER_SUMMARY_FOUND"
    TRANSLATION_TEXT_SCANNER_SUMMARY_OOB = "TRANSLATION_TEXT_SCANNER_SUMMARY_OOB"
    TRANSLATION_TEXT_SCANNER_SUMMARY_UNDECODABLE = "TRANSLATION_TEXT_SCANNER_SUMMARY_UNDECODABLE"
    TRANSLATION_TEXT_SCANNER_NO_FILE = "TRANSLATION_TEXT_SCANNER_NO_FILE"
    TRANSLATION_TEXT_SCANNER_INVALID_PARAMS = "TRANSLATION_TEXT_SCANNER_INVALID_PARAMS"
    TRANSLATION_TEXT_SCANNER_INVALID_DIMENSIONS = "TRANSLATION_TEXT_SCANNER_INVALID_DIMENSIONS"
...
TRANSLATION_MEMORY: List[TranslationEntry] = [
    ...
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_TOOLSMENU_TOOLS, default="Tools"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_TOOLSMENU_OFFSET_SCANNER, default="Offset Scanner..."),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_SCANNER_WINDOW_TITLE, default="Candidate Offset Scanner"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_SCANNER_PARAMS_FRAME, default="Scan Parameters"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_SCANNER_START, default="Start Offset (Dec/Hex)"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_SCANNER_END, default="End Offset (Dec/Hex)"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_SCANNER_STEP, default="Step (Dec/Hex)"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_SCANNER_ALIGNMENT, default="Alignment"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_SCANNER_MAX_RESULTS, default="Max Results"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_SCANNER_SCAN, default="Scan"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_SCANNER_CANCEL, default="Cancel"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_SCANNER_CLOSE, default="Close"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_SCANNER_RESULTS_FRAME, default="Candidates"),
    TranslationEntry(
        id=TranslationKeys.TRANSLATION_TEXT_SCANNER_STATUS_READY, default="Set parameters and click Scan."
    ),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_SCANNER_STATUS_SCANNING, default="Scanning..."),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_SCANNER_STATUS_DONE, default="Done"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_SCANNER_STATUS_CANCELLED, default="Cancelled"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_SCANNER_STATUS_LIMIT, default="Result limit reached"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_SCANNER_SUMMARY_SCANNED, default="Scanned"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_SCANNER_SUMMARY_FOUND, default="Found"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_SCANNER_SUMMARY_OOB, default="Out-of-bounds"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_SCANNER_SUMMARY_UNDECODABLE, default="Undecodable"),
    TranslationEntry(
        id=TranslationKeys.TRANSLATION_TEXT_SCANNER_NO_FILE, default="Please open an image file first."
    ),
    TranslationEntry(
        id=TranslationKeys.TRANSLATION_TEXT_SCANNER_INVALID_PARAMS,
        default="Invalid scan parameters. Check start/end/step values.",
    ),
    TranslationEntry(
        id=TranslationKeys.TRANSLATION_TEXT_SCANNER_INVALID_DIMENSIONS,
        default="Set a valid image width and height first.",
    ),
]
