...
class TranslationKeys(str, Enum):
    ...
    # offset scanner
    TRANSLATION_TEXT_TOOLS_MENU = "TRANSLATION_TEXT_TOOLS_MENU"
    TRANSLATION_TEXT_SCAN_OFFSETS = "TRANSLATION_TEXT_SCAN_OFFSETS"
    TRANSLATION_TEXT_SCANNER_TITLE = "TRANSLATION_TEXT_SCANNER_TITLE"
    TRANSLATION_TEXT_SCANNER_START_OFFSET = "TRANSLATION_TEXT_SCANNER_START_OFFSET"
    TRANSLATION_TEXT_SCANNER_END_OFFSET = "TRANSLATION_TEXT_SCANNER_END_OFFSET"
    ...
    TRANSLATION_TEXT_SCANNER_START_BTN = "TRANSLATION_TEXT_SCANNER_START_BTN"
    TRANSLATION_TEXT_SCANNER_CANCEL_BTN = "TRANSLATION_TEXT_SCANNER_CANCEL_BTN"
    TRANSLATION_TEXT_SCANNER_SCANNING = "TRANSLATION_TEXT_SCANNER_SCANNING"
    TRANSLATION_TEXT_SCANNER_COMPLETE = "TRANSLATION_TEXT_SCANNER_COMPLETE"
    TRANSLATION_TEXT_SCANNER_SUMMARY_SCANNED = "TRANSLATION_TEXT_SCANNER_SUMMARY_SCANNED"
    TRANSLATION_TEXT_SCANNER_SUMMARY_VALID = "TRANSLATION_TEXT_SCANNER_SUMMARY_VALID"
    TRANSLATION_TEXT_SCANNER_SUMMARY_SKIPPED = "TRANSLATION_TEXT_SCANNER_SUMMARY_SKIPPED"
    TRANSLATION_TEXT_SCANNER_NO_FILE = "TRANSLATION_TEXT_SCANNER_NO_FILE"
    TRANSLATION_TEXT_SCANNER_RESULTS = "TRANSLATION_TEXT_SCANNER_RESULTS"
    TRANSLATION_TEXT_SCANNER_CLICK_TO_APPLY = "TRANSLATION_TEXT_SCANNER_CLICK_TO_APPLY"
...
TRANSLATION_MEMORY: List[TranslationEntry] = [
    ...
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_TOOLS_MENU, default="Tools"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_SCAN_OFFSETS, default="Scan Offsets..."),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_SCANNER_TITLE, default="Offset Scanner"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_SCANNER_START_OFFSET, default="Start Offset (Dec/Hex)"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_SCANNER_END_OFFSET, default="End Offset (Dec/Hex)"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_SCANNER_STEP, default="Step Size"),
    ...
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_SCANNER_START_BTN, default="Start Scan"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_SCANNER_CANCEL_BTN, default="Cancel"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_SCANNER_SCANNING, default="Scanning..."),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_SCANNER_COMPLETE, default="Scan complete"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_SCANNER_SUMMARY_SCANNED, default="Scanned"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_SCANNER_SUMMARY_VALID, default="Valid"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_SCANNER_SUMMARY_SKIPPED, default="Skipped"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_SCANNER_NO_FILE, default="Please open a file first!"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_SCANNER_RESULTS, default="Scan Results"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_SCANNER_CLICK_TO_APPLY, default="Click to apply offset"),
]
