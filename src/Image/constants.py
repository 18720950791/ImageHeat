...
class TranslationKeys(str, Enum):
    ...
    TRANSLATION_TEXT_PROBES_MENU = "TRANSLATION_TEXT_PROBES_MENU"
    TRANSLATION_TEXT_PROBES_WINDOW_TITLE = "TRANSLATION_TEXT_PROBES_WINDOW_TITLE"
    TRANSLATION_TEXT_PROBES_SHOW_LIST = "TRANSLATION_TEXT_PROBES_SHOW_LIST"
    TRANSLATION_TEXT_PROBES_SHORTCUT_SHOW_LIST = "TRANSLATION_TEXT_PROBES_SHORTCUT_SHOW_LIST"
    TRANSLATION_TEXT_PROBES_EXPORT_CSV_MENU = "TRANSLATION_TEXT_PROBES_EXPORT_CSV_MENU"
    TRANSLATION_TEXT_PROBES_CLEAR_ALL = "TRANSLATION_TEXT_PROBES_CLEAR_ALL"
    TRANSLATION_TEXT_PROBES_COPY_SELECTED = "TRANSLATION_TEXT_PROBES_COPY_SELECTED"
    TRANSLATION_TEXT_PROBES_EXPORT_CSV = "TRANSLATION_TEXT_PROBES_EXPORT_CSV"
    TRANSLATION_TEXT_PROBES_REMOVE_SELECTED = "TRANSLATION_TEXT_PROBES_REMOVE_SELECTED"
    TRANSLATION_TEXT_PROBES_HINT = "TRANSLATION_TEXT_PROBES_HINT"
    TRANSLATION_TEXT_PROBES_COUNT = "TRANSLATION_TEXT_PROBES_COUNT"
    TRANSLATION_TEXT_PROBES_COL_INDEX = "TRANSLATION_TEXT_PROBES_COL_INDEX"
    TRANSLATION_TEXT_PROBES_COL_X = "TRANSLATION_TEXT_PROBES_COL_X"
    TRANSLATION_TEXT_PROBES_COL_Y = "TRANSLATION_TEXT_PROBES_COL_Y"
    TRANSLATION_TEXT_PROBES_COL_OFFSET = "TRANSLATION_TEXT_PROBES_COL_OFFSET"
    TRANSLATION_TEXT_PROBES_COL_FILE_OFFSET = "TRANSLATION_TEXT_PROBES_COL_FILE_OFFSET"
    TRANSLATION_TEXT_PROBES_COL_RGBA = "TRANSLATION_TEXT_PROBES_COL_RGBA"
    TRANSLATION_TEXT_PROBES_COL_HEX = "TRANSLATION_TEXT_PROBES_COL_HEX"
    TRANSLATION_TEXT_PROBES_CSV_SAVED = "TRANSLATION_TEXT_PROBES_CSV_SAVED"
    TRANSLATION_TEXT_PROBES_NONE_TO_EXPORT = "TRANSLATION_TEXT_PROBES_NONE_TO_EXPORT"
    TRANSLATION_TEXT_PROBES_NONE_SELECTED = "TRANSLATION_TEXT_PROBES_NONE_SELECTED"
    TRANSLATION_TEXT_PROBES_COPIED = "TRANSLATION_TEXT_PROBES_COPIED"
...
TRANSLATION_MEMORY: List[TranslationEntry] = [
    ...
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_PROBES_MENU, default="Pixel Probes"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_PROBES_WINDOW_TITLE, default="Pixel Probes"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_PROBES_SHOW_LIST, default="Show Probe List"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_PROBES_SHORTCUT_SHOW_LIST, default="Ctrl+B"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_PROBES_EXPORT_CSV_MENU, default="Export Probes to CSV..."),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_PROBES_CLEAR_ALL, default="Clear All Probes"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_PROBES_COPY_SELECTED, default="Copy Selected"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_PROBES_EXPORT_CSV, default="Export CSV..."),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_PROBES_REMOVE_SELECTED, default="Remove Selected"),
    TranslationEntry(
        id=TranslationKeys.TRANSLATION_TEXT_PROBES_HINT,
        default="Left-click on the preview to add a pixel probe.",
    ),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_PROBES_COUNT, default="Probes: "),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_PROBES_COL_INDEX, default="#"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_PROBES_COL_X, default="X"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_PROBES_COL_Y, default="Y"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_PROBES_COL_OFFSET, default="Offset"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_PROBES_COL_FILE_OFFSET, default="File Offset"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_PROBES_COL_RGBA, default="RGBA"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_PROBES_COL_HEX, default="Hex (RGBA)"),
    TranslationEntry(
        id=TranslationKeys.TRANSLATION_TEXT_PROBES_CSV_SAVED, default="Probes exported to CSV successfully!"
    ),
    TranslationEntry(
        id=TranslationKeys.TRANSLATION_TEXT_PROBES_NONE_TO_EXPORT, default="There are no probes to export!"
    ),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_PROBES_NONE_SELECTED, default="No probe selected!"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_PROBES_COPIED, default="Copied probe info to clipboard!"),
]
