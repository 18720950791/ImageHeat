...
class ConfigKeys(str, Enum):
    ...
    BATCH_EXPORT_DIRECTORY_PATH = "batch_export_directory_path"
...
class TranslationKeys(str, Enum):
    ...
    TRANSLATION_TEXT_BATCH_FORMAT = "TRANSLATION_TEXT_BATCH_FORMAT"
    TRANSLATION_TEXT_BATCH_OUTPUT_DIR = "TRANSLATION_TEXT_BATCH_OUTPUT_DIR"
    TRANSLATION_TEXT_BATCH_BROWSE = "TRANSLATION_TEXT_BATCH_BROWSE"
    TRANSLATION_TEXT_BATCH_FILENAME_TEMPLATE = "TRANSLATION_TEXT_BATCH_FILENAME_TEMPLATE"
    TRANSLATION_TEXT_BATCH_TEMPLATE_HELP = "TRANSLATION_TEXT_BATCH_TEMPLATE_HELP"
    ...
    TRANSLATION_TEXT_BATCH_STATUS_IDLE = "TRANSLATION_TEXT_BATCH_STATUS_IDLE"
    TRANSLATION_TEXT_BATCH_STATUS_RUNNING = "TRANSLATION_TEXT_BATCH_STATUS_RUNNING"
    TRANSLATION_TEXT_BATCH_STATUS_DONE = "TRANSLATION_TEXT_BATCH_STATUS_DONE"
    TRANSLATION_TEXT_BATCH_STATUS_CANCELLED = "TRANSLATION_TEXT_BATCH_STATUS_CANCELLED"
    TRANSLATION_TEXT_BATCH_RESULT_OK = "TRANSLATION_TEXT_BATCH_RESULT_OK"
    TRANSLATION_TEXT_BATCH_RESULT_FAIL = "TRANSLATION_TEXT_BATCH_RESULT_FAIL"
...
TRANSLATION_MEMORY: List[TranslationEntry] = [
    ...
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_BATCH_FORMAT, default="Output Format:"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_BATCH_OUTPUT_DIR, default="Output Directory:"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_BATCH_BROWSE, default="Browse..."),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_BATCH_FILENAME_TEMPLATE, default="Filename Template:"),
    TranslationEntry(
        id=TranslationKeys.TRANSLATION_TEXT_BATCH_TEMPLATE_HELP,
        default="{name} = original filename, {n} = sequence number",
    ),
    ...
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_BATCH_STATUS_IDLE, default="Ready"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_BATCH_STATUS_RUNNING, default="Processing"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_BATCH_STATUS_DONE, default="Completed"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_BATCH_STATUS_CANCELLED, default="Cancelled"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_BATCH_RESULT_OK, default="OK"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_BATCH_RESULT_FAIL, default="FAILED"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_BATCH_FILES_SELECTED, default="file(s) selected"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_BATCH_NO_FILES, default="No files selected!"),
    TranslationEntry(
        id=TranslationKeys.TRANSLATION_TEXT_BATCH_NO_OUTPUT_DIR, default="Please select an output directory!"
    ),
]
