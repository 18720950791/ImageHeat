...
class TranslationKeys(str, Enum):
    ...
    # Batch Export
    TRANSLATION_TEXT_FILEMENU_BATCH_EXPORT = "TRANSLATION_TEXT_FILEMENU_BATCH_EXPORT"
    TRANSLATION_TEXT_BATCH_TITLE = "TRANSLATION_TEXT_BATCH_TITLE"
    TRANSLATION_TEXT_BATCH_INPUT_FILES = "TRANSLATION_TEXT_BATCH_INPUT_FILES"
    TRANSLATION_TEXT_BATCH_BROWSE_FILES = "TRANSLATION_TEXT_BATCH_BROWSE_FILES"
    TRANSLATION_TEXT_BATCH_OUTPUT_FORMAT = "TRANSLATION_TEXT_BATCH_OUTPUT_FORMAT"
    TRANSLATION_TEXT_BATCH_OUTPUT_DIR = "TRANSLATION_TEXT_BATCH_OUTPUT_DIR"
    TRANSLATION_TEXT_BATCH_BROWSE_DIR = "TRANSLATION_TEXT_BATCH_BROWSE_DIR"
    TRANSLATION_TEXT_BATCH_NAMING = "TRANSLATION_TEXT_BATCH_NAMING"
    TRANSLATION_TEXT_BATCH_NAMING_ORIGINAL = "TRANSLATION_TEXT_BATCH_NAMING_ORIGINAL"
    TRANSLATION_TEXT_BATCH_NAMING_NUMBERED = "TRANSLATION_TEXT_BATCH_NAMING_NUMBERED"
    TRANSLATION_TEXT_BATCH_NAMING_PREFIX = "TRANSLATION_TEXT_BATCH_NAMING_PREFIX"
    TRANSLATION_TEXT_BATCH_PREFIX = "TRANSLATION_TEXT_BATCH_PREFIX"
    TRANSLATION_TEXT_BATCH_START = "TRANSLATION_TEXT_BATCH_START"
    TRANSLATION_TEXT_BATCH_CANCEL = "TRANSLATION_TEXT_BATCH_CANCEL"
    TRANSLATION_TEXT_BATCH_CLOSE = "TRANSLATION_TEXT_BATCH_CLOSE"
    TRANSLATION_TEXT_BATCH_PROGRESS = "TRANSLATION_TEXT_BATCH_PROGRESS"
    TRANSLATION_TEXT_BATCH_LOG = "TRANSLATION_TEXT_BATCH_LOG"
    TRANSLATION_TEXT_BATCH_COMPLETE = "TRANSLATION_TEXT_BATCH_COMPLETE"
    TRANSLATION_TEXT_BATCH_STATUS_OK = "TRANSLATION_TEXT_BATCH_STATUS_OK"
    TRANSLATION_TEXT_BATCH_STATUS_FAIL = "TRANSLATION_TEXT_BATCH_STATUS_FAIL"
    TRANSLATION_TEXT_BATCH_STATUS_CANCELLED = "TRANSLATION_TEXT_BATCH_STATUS_CANCELLED"
    TRANSLATION_TEXT_BATCH_NO_FILES = "TRANSLATION_TEXT_BATCH_NO_FILES"
    TRANSLATION_TEXT_BATCH_NO_OUTPUT_DIR = "TRANSLATION_TEXT_BATCH_NO_OUTPUT_DIR"
    TRANSLATION_TEXT_BATCH_FILES_SELECTED = "TRANSLATION_TEXT_BATCH_FILES_SELECTED"
    TRANSLATION_TEXT_BATCH_PROCESSING = "TRANSLATION_TEXT_BATCH_PROCESSING"
...
TRANSLATION_MEMORY: List[TranslationEntry] = [
    ...
    # Batch Export
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_FILEMENU_BATCH_EXPORT, default="Batch Export..."),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_BATCH_TITLE, default="Batch Export"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_BATCH_INPUT_FILES, default="Input Files"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_BATCH_BROWSE_FILES, default="Browse Files..."),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_BATCH_OUTPUT_FORMAT, default="Output Format"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_BATCH_OUTPUT_DIR, default="Output Directory"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_BATCH_BROWSE_DIR, default="Browse..."),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_BATCH_NAMING, default="File Naming"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_BATCH_NAMING_ORIGINAL, default="Original Name"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_BATCH_NAMING_NUMBERED, default="Name + Number"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_BATCH_NAMING_PREFIX, default="Custom Prefix"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_BATCH_PREFIX, default="Prefix"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_BATCH_START, default="Start"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_BATCH_CANCEL, default="Cancel"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_BATCH_CLOSE, default="Close"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_BATCH_PROGRESS, default="Progress"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_BATCH_LOG, default="Log"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_BATCH_COMPLETE, default="Batch export complete"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_BATCH_STATUS_OK, default="OK"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_BATCH_STATUS_FAIL, default="FAIL"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_BATCH_STATUS_CANCELLED, default="CANCELLED"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_BATCH_NO_FILES, default="No files selected"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_BATCH_NO_OUTPUT_DIR, default="No output directory selected"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_BATCH_FILES_SELECTED, default="files selected"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_BATCH_PROCESSING, default="Processing..."),
]
